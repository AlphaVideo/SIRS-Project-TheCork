...
mysql -u sirs -psirs thecork -e "CREATE TABLE auth_tokens(id INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL, nonce INT(16) NOT NULL, username VARCHAR(50) UNIQUE NOT NULL, expiration_date DATETIME NOT NULL, PRIMARY KEY(id,nonce), FOREIGN KEY (username) REFERENCES client(username));"
